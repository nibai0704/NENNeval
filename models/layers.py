...
from utils import DSN #这个实际上没有用
...
class GraphAttentionLayer(nn.Module):
    ...
    def forward(self, h, edge_attr):
        # print('forward\n') 调用了四次
        Wh = torch.mm(h, self.W) # h.shape: (N, in_features)2708 1433, Wh.shape: (N, out_features) 2078 64
        e = self._prepare_attentional_mechanism_input(Wh, edge_attr)# 2708 2708
        e=e*edge_attr#[3, 2708, 2708]
